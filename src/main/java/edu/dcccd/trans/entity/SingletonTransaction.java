...
public class SingletonTransaction
{
    ...
    private SingletonTransaction()
    {
        ...
        Transaction tr01 = new Transaction(1001L,"REVENUE","SUNDAY", BigDecimal.valueOf(100.00),
                "A Revenue");
        Transaction tr02 = new Transaction(1002L,"EXPENSE","MONDAY", BigDecimal.valueOf(25.00),
                "An Expense");
